...
select 
  ...
  Sessions___GA4__Google_Analytics as sessions, 
  case when Session_medium___GA4__Google_Analytics = '(other)' then 0 else Sessions___GA4__Google_Analytics end as sessions_ga,
